// fichier: liste-employe-attente.component.ts
...
@Component({
  selector: 'app-liste-employe-attente',
  templateUrl: './liste-employe-attente.component.html',
  styleUrls: ['./liste-employe-attente.component.css']
})
export class ListeEmployeAttenteComponent implements OnInit, AfterViewInit {
  employes: Employe[] = [];
